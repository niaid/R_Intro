...
#### 8.Format data
<br /> 
Format statistical test results, use functions in "apa" package. There are limited type of statistical results could be formatted in this function, for details see [reference manual](https://cran.r-project.org/web/packages/apa/apa.pdf).
```{r}
